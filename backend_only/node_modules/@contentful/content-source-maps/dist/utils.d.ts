...
export declare function encodeField(fieldType: FieldType, currentValue: any, hiddenStrings: SourceMapMetadata, target: GraphQLResponse | CPAEntry, pointer: string, mappings: CPAMappings | GraphQLMappings, locale?: string): void;
